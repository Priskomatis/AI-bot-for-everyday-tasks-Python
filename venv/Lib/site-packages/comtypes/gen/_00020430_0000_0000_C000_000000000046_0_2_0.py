...
__all__ = [ 'Default', 'FONTSIZE', 'Unchecked', 'OLE_CANCELBOOL',
           'FontEvents', 'LoadPictureConstants', 'OLE_XPOS_HIMETRIC',
           'IFont', 'StdPicture', 'OLE_XPOS_CONTAINER',
           'FONTUNDERSCORE', 'IPictureDisp', 'OLE_YSIZE_CONTAINER',
           'FONTBOLD', 'FONTNAME', 'Font', 'OLE_XPOS_PIXELS', 'Gray',
           'OLE_XSIZE_HIMETRIC', 'IFontDisp', 'StdFont',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'OLE_HANDLE', 'OLE_ENABLEDEFAULTBOOL',
           'IFontEventsDisp', 'OLE_XSIZE_PIXELS', 'VgaColor', 'Color',
           'FONTITALIC', 'OLE_TRISTATE', 'Monochrome', 'OLE_COLOR',
           'Checked', 'Picture', 'OLE_YPOS_PIXELS',
           'OLE_OPTEXCLUSIVE', 'IPicture', 'FONTSTRIKETHROUGH',
           'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC']
from comtypes import _check_version; _check_version('1.1.10', 1575709733.660234)
